...
use Home\BackendBundle\Entity\Cursos;
use Home\BackendBundle\Form\CursosType;
use Home\BackendBundle\Form\CursosFilterType;
...
class CursosController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('HomeBackendBundle:Cursos')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('CursosControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('CursosControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('CursosControllerFilter')) {
                $filterData = $session->get('CursosControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new CursosFilterType(), $filterData, array(
            'action' => $this->generateUrl('admin_cursos'),
            'method' => 'GET',
        ));
     ...
     *
     * @Route("/", name="admin_cursos_create")
     * @Method("POST")
     * @Template("HomeBackendBundle:Cursos:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('admin_cursos_new')
                    : $this->generateUrl('admin_cursos_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HomeBackendBundle:Cursos')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_cursos_update")
     * @Method("PUT")
     * @Template("HomeBackendBundle:Cursos:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('admin_cursos_new')
                        : $this->generateUrl('admin_cursos_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
