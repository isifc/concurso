...
use Home\BackendBundle\Form\PersonaType;
use Home\BackendBundle\Form\PersonaFilterType;
...
class PersonaController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('HomeBackendBundle:Persona')
    ...
    */
    ...
    {
        $form = $this->createForm(new PersonaFilterType(), $filterData, array(
            'action' => $this->generateUrl('admin_persona'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("HomeBackendBundle:Persona:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('admin_persona_new')
                    : $this->generateUrl('admin_persona_show', array('id' => $entity->getId()));
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HomeBackendBundle:Persona:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('admin_persona_new')
                        : $this->generateUrl('admin_persona_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
