...
/**
 * EstudioPrimarioFilterType filtro.
 * @author Nombre Apellido <name@gmail.com>
 */
class EstudioPrimarioFilterType extends AbstractType
{
        /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('cantidadMaterias', 'filter_number_range',array(
                        'attr'=> array('class'=>'form-control')
                    ))
        ;
    ...
    {
        return 'home_backendbundle_estudioprimariofiltertype';
    }
}
